...
export const modulo7 = {
  ...
  resumo:
    'Operar com método: regra escrita antes, tamanho que aguenta ir a zero, saída ' +
    'automática, diário e revisão — e o que cada peça tem de evidência.',

  // Subtítulo do cabeçalho da página, como no desenho: o resumo sem a primeira frase.
  subtitulo:
    'Regra escrita antes, tamanho que aguenta ir a zero, saída que executa sozinha, diário ' +
    'do que você pensou e revisão do comportamento, não do saldo — e o que cada peça tem de ' +
    'evidência, e o que não tem.',
  ...
  avisoDoCabecalho: {
    ...
    texto:
      ...
      'sua, escrita antes de ver o próximo token. Nenhum campo vem preenchido, e todo exemplo ' +
      'vem marcado como exemplo.',
  },

  objetivos: [
    'Escrever uma regra conferível — a regra é sua; o módulo mostra a forma.',
  ...
  secoes: [
    // ================================ A REGRA ================================
    {
      ...
      memoria: {
        ...
        conclusao: {
          ...
          texto:
            'Planos "se acontecer X, eu faço Y", feitos antes, aumentam a chance de cumprir o ' +
            'que se planejou — resultado repetido da psicologia do comportamento.',
        },
      },
      paragrafos: [
        'Uma regra de operação é um texto curto, escrito e datado, que diz o que você vai ' +
          'fazer antes de ter qualquer resultado. Não adivinha o futuro: só registra, de ' +
          'cabeça fria, o seu critério. Decidir antes e se amarrar à decisão se chama ' +
          'pré-compromisso.',
        'A memória guarda histórias, não decisões, e reescreve a história quando o final ' +
          'muda. Deu certo: "eu sabia" (viés de retrospectiva: parecer, depois, que era ' +
          'previsível) e "foi habilidade" (viés de autoatribuição: ganho é mérito, perda é ' +
          'azar). Deu errado: "foi azar". A decisão foi a mesma; mudou o resultado.',
        'Escreva antes de abrir a próxima tela de token: com o gráfico na frente, o texto já ' +
          'nasce contaminado. E escreva no seu caderno: nenhum campo deste hub guarda a ' +
          'regra.',
      ],
      exemplo: {
        titulo: 'Pré-compromisso medido: o que funcionou e o que não colou',
        passos: [
          'Nas Filipinas, um banco ofereceu uma poupança que travava os saques até uma data combinada.',
          'Entre quem aceitou, a poupança aumentou cerca de 82% em um ano — o compromisso funcionou.',
          'Só 28% das pessoas aceitaram abrir a conta.',
          'Outros estudos mostram muita gente abandonando o compromisso antes do prazo.',
          'Os dois números andam juntos: efeito grande em quem aceitou, adesão pequena.',
        ],
      },
      paragrafosFinais: [
        'O erro que isso evita é revisar de memória: ela já ajeitou a história ao resultado, ' +
          'e a decisão sempre parece coerente. Com a regra escrita, a revisão compara o que ' +
          'estava escrito com o que você fez.',
        'Atenção ao que está medido: o plano feito antes aumenta a chance de cumpri-lo, não a de ' +
          'ganhar dinheiro. Escrever a regra não a melhora; só faz você ficar do lado dela.',
      ],
      detalhe: {
        ...
        paragrafos: [
          'O resultado dos planos "se acontecer X, eu faço Y" é de Gollwitzer & Sheeran (2006), ' +
            'medido em metas de comportamento em geral, não em operações.',
          {
            destaque: 'Pré-compromisso funciona, e falha com frequência.',
            texto:
              'A conta das Filipinas é de Ashraf, Karlan & Yin (2006). A lição: o ' +
              'compromisso precisa ser rígido para valer e simples para você manter; regra ' +
              'rígida demais para a sua vida acaba quebrada toda semana.',
          },
          'Os dois foram confirmados por artigos revisados por pares (conferidos por outros ' +
            'pesquisadores antes de sair) que os citam, não pelos originais, de acesso pago.',
        ],
      },
    },
    {
      ...
      emUmaFrase:
        'Regra que não dá para conferir depois não é regra: é intenção. Cada parte é escrita de ' +
        'um jeito que outra pessoa conseguiria verificar no seu diário.',
      ...
      partes: [
        {
          ...
          oQueTem:
            'O que precisa acontecer, de um jeito visível, para você comprar. O checklist é ' +
            'o filtro mínimo; o gatilho é seu.',
          placeholder: 'Escreva o seu gatilho, de um jeito verificável',
          exemplo:
            'Um fato observável e um momento — não "quando parecer bom".',
        },
        {
          id: 'tamanho',
          rotulo: 'Tamanho',
          ...
          exemplo: 'Uma porcentagem do capital de hoje, não um valor em reais que envelhece.',
        },
        {
          id: 'perda',
          ...
          exemplo:
            'O nível e quem executa: você programou a ordem, ou depende de estar olhando?',
        },
        {
          id: 'ganho',
          ...
          exemplo:
            'Faixas definidas antes e um prazo: "espero até quando?" precisa ter resposta.',
        },
        {
          id: 'invalida',
          ...
          exemplo:
            'Uma condição conferível no diário, não a sensação de que "não está funcionando".',
        },
      ],
      rodape: [
        [
          ...
          ' de uma resposta verificável, nunca um limiar, um percentual ou um gatilho a seguir. ' +
            'O hub não sabe o seu capital, o seu prazo nem o que você aceita perder.',
        ],
        'Nada digitado aqui é salvo: esta tela é a forma, e o lugar da regra é o seu caderno.',
      ],
      paragrafos: [
        'Uma regra completa responde cinco perguntas: quando entro, com quanto, onde saio se der ' +
          'errado, onde saio se der certo ou se nada acontecer, e o que me faria abandoná-la.',
        'A palavra-chave é verificável: lendo só o seu diário, outra pessoa consegue dizer ' +
          'sim ou não. "Comprei quando pareceu bom" não passa, porque ninguém confere ' +
          '"pareceu"; um fato observável mais um momento passa.',
        'É isso que a revisão compara: na aba O diário, o "segui a regra?" sai de pôr lado a ' +
          'lado o que estava escrito e o que ficou registrado, não da lembrança. Regra ' +
          'impossível de conferir deixa a revisão sem base.',
      ],
      exemplo: {
        titulo: 'Por que o tamanho é escrito em porcentagem, e não em valor fixo',
        passos: [
          'Capital de 100, posição de 10 (o mesmo exemplo da aba Tamanho).',
          'Em porcentagem, o tamanho é "10% do capital de hoje".',
          'Em valor fixo, é "10". Parece a mesma coisa.',
          'A posição vai a zero e o capital cai para 90: o valor fixo de 10 virou uma fatia maior do que sobrou.',
          'A porcentagem se ajusta sozinha; o valor fixo envelhece e aperta sem você perceber.',
        ],
      },
      paragrafosFinais: [
        'O erro que isso evita é a regra pela metade: decide quando entrar e nada sobre ' +
          'sair, e a saída fica para o pior momento, com a posição aberta. Por isso três das ' +
          'cinco partes tratam de saída ou abandono.',
        'A quinta parte é a que quase todo mundo pula. Sem ela, a regra vai sendo ajustada a ' +
          'cada perda até virar outra; com ela, abandonar a regra não vira decisão no susto.',
      ],
    },
    {
      id: 'ciclo',
      ...
      ciclo: {
        ...
        descricao:
          'Escrevo a regra e passo o token pelo checklist. Reprovou: não compro e anoto o ' +
          'motivo. Passou: se o gatilho da minha regra não aconteceu, não compro e anoto o ' +
          'motivo; se aconteceu, entro com o tamanho da regra e a saída programada. Anoto no ' +
          'diário antes do resultado; a saída executa e eu a anoto. Na revisão: segui a ' +
          'regra? Só aqui a regra muda, e volta ao começo.',
      },
      paragrafos: [
        'O ciclo começa fora do mercado, com a regra escrita, e termina fora dele, na revisão. O ' +
          'meio, com o dinheiro lá dentro, é curto: quase tudo foi decidido antes do clique.',
        'Há dois filtros. O checklist, a lista de conferência do hub, é o mínimo, igual para ' +
          'qualquer token. O gatilho é só seu. Passar no checklist não é sinal de compra.',
        'Quando reprova, anote o motivo: é esse registro que mostra, na revisão, se o filtro ' +
          'funciona ou se você vem inventando exceções.',
        'A regra só muda na revisão. No meio da operação, trate-a como se fosse de outra ' +
          'pessoa: a que a escreveu sem ver o preço andar.',
      ],
      exemplo: {
        titulo: 'Os três fins possíveis, e todos os três viram registro',
        passos: [
          'O token reprova no checklist: não compro, e anoto o motivo. Fim.',
          'Passa no checklist, mas o meu gatilho não aconteceu: não compro, e anoto o motivo. Fim.',
          'Passou e o gatilho aconteceu: entro com o tamanho da regra e a saída já programada.',
          'Anoto no diário antes de ver o resultado; a saída executa; anoto a saída executada.',
          'Na revisão, comparo o escrito com o executado — só aqui a regra pode mudar.',
        ],
      },
      paragrafosFinais: [
        'O erro que isso evita é mudar a regra com a posição aberta: o alvo vira "vou ' +
          'segurar mais um pouco", a saída por perda vira "isso ainda volta". Aí quem decide ' +
          'é uma versão sua com dinheiro em jogo.',
        'O ciclo não diz o que comprar nem quando. Só garante um registro conferível a cada ' +
          'volta e um único momento certo para mudar de ideia.',
      ],
    },
    {
      id: 'stop-automatico',
      ...
      paragrafos: [
        'Stop-loss é uma ordem de venda automática: você programa antes um nível de preço, e ' +
          'a venda acontece sozinha quando o preço chega lá. Alarme só avisa; intenção só ' +
          'existe na cabeça.',
        'O experimento mediu comportamento, não lucro: não mostrou que o stop dá mais ' +
          'dinheiro, e sim que muda o que a pessoa faz. E mediu a direção do efeito, não o ' +
          'tamanho.',
        'Segurar posição perdedora (o efeito disposição do Módulo 2) é hábito teimoso: a ' +
          'pessoa sabe que deveria sair, promete, e não sai. O que corrige é a execução, não ' +
          'a intenção — por isso a terceira parte da regra pergunta quem executa a saída.',
        'A saída é programada na entrada: com a posição aberta, o nível que você escolheria ' +
          'já muda. E há limites em memecoin: numa queda rápida, a ordem pode sair bem ' +
          'abaixo do nível (o slippage do Módulo 5); e vale o aviso do Módulo 5 sobre a ' +
          'ordem limite: não assuma que a ordem dispara com o app fechado — teste com valor ' +
          'mínimo. O stop reduz o dano; não garante o preço.',
      ],
      exemplo: {
        titulo: 'O mesmo nível, dois caminhos',
        passos: [
          'Caminho A: na entrada, você programa a ordem de venda no nível escrito na regra.',
          'O preço chega lá às três da manhã e a ordem executa sozinha. Você anota a saída no dia seguinte.',
          'Caminho B: você anota o mesmo nível num lembrete e promete vender quando chegar.',
          'O preço chega lá às três da manhã e você está dormindo. Acordado, ainda teria de decidir de novo, com a perda na tela.',
          'O nível escrito é idêntico nos dois casos. O que muda é quem aperta o botão.',
        ],
      },
      paragrafosFinais: [
        'O erro que isso evita é confundir ter decidido com ter programado: saída só ' +
          'decidida volta a ser decisão no pior momento. O lembrete parece compromisso e não ' +
          'é.',
      ],
      detalhe: {
        ...
        paragrafos: [
          'O experimento é de Fischbacher, Hoffmann & Schudy (2017), confirmado por um artigo ' +
            'revisado por pares que o cita, e não pelo original, de acesso pago.',
          'Foi feito com investidores em ambiente de experimento, não com memecoin. Trazer para ' +
            'cá é inferência razoável (o efeito é sobre comportamento humano), não medição feita ' +
            'aqui.',
        ],
      },
    },
    ...
    // =============================== TAMANHO =================================
    {
      ...
      emUmaFrase:
        'Arriscar sempre a mesma porcentagem do capital de hoje. O tamanho encolhe quando ' +
        'você perde e cresce quando ganha, sem decidir de novo.',
      ...
      mecanismo: {
        ...
        etiqueta: 'só exemplo, não sugestão de fração',
        descricao:
      ...
      paragrafos: [
        'Fração fixa é decidir o tamanho da posição como uma porcentagem do capital de hoje: ' +
          'fixa é a porcentagem, não o valor. Banca é o capital todo que você separou para isso; a ' +
          'fração é sempre uma fatia dela.',
        'No desenho, o tamanho encolheu sem ninguém decidir, e cresceria do mesmo jeito se o ' +
          'capital subisse: segue o capital, não o gráfico da hora.',
        'Por isso uma perda nunca zera a banca. Decidir o tamanho pelo quanto o token parece ' +
          'promissor põe a maior posição onde a convicção é maior — quando a memória está ' +
          'mais pronta para reescrever a história.',
        'O "arrisque de 1% a 2% por operação" que circula é convenção de mercado: nenhum estudo ' +
          'revisado por pares o fixa como ótimo. A sua fração depende do seu capital e do que você ' +
          'aceita perder; o módulo não escreve esse número.',
      ],
      quadro: [
        {
          rotulo: 'Isto é conta',
          texto:
            'O mecanismo. Dado o capital e a porcentagem, o tamanho sai por aritmética, igual ' +
            'para qualquer pessoa.',
        },
        {
          rotulo: 'Isto não é medição',
          texto:
            'Nada aqui diz que 10% é bom ou ruim: é um número redondo que deixa a conta ' +
            'visível.',
          destaque: true,
        },
      ],
      paragrafosFinais: [
        'O erro que isso evita é o tamanho pelo entusiasmo: pequeno quando inseguro, grande ' +
          'quando animado, e as poucas posições grandes decidem o mês.',
        'Qual fração é a melhor? O critério de Kelly, fórmula famosa, calcula a fração que ' +
          'faz o capital crescer mais rápido no longo prazo. Em memecoin ela quebra: os ' +
          'resultados extremos aparecem tanto (a "cauda pesada") que a média pode nem se ' +
          'firmar, e sem média a fórmula não dá número. Detalhe em "Para ir mais fundo".',
      ],
      detalhe: {
        titulo: 'por que o critério de Kelly quebra aqui',
        paragrafos: [
          'Na versão para ativos, a fórmula de Kelly é f* = μ ÷ σ², em que μ é o retorno ' +
            'esperado (a média dos resultados) e σ² é a variância (o tamanho típico das ' +
            'oscilações em torno da média). A fórmula só funciona se as duas existirem; numa ' +
            'cauda muito pesada, a variância pode ser infinita e a média pode nem existir.',
          '"Cauda pesada" é quando os casos extremos aparecem demais para a média se comportar. ' +
            'Com cauda leve, muitos resultados fazem a média assentar. Com cauda muito pesada, um ' +
            'único caso extremo mexe na média de tudo o que veio antes, e ela nunca assenta.',
          'Um caso simples: numa aposta com 50% de chance de dobrar e 50% de perder tudo, a ' +
            'fração de Kelly é 0 — f* = (0,5 × 1 − 0,5) ÷ 1 (chance de ganhar × quanto ' +
            'ganha, menos chance de perder, dividido por quanto ganha). A perda total domina ' +
            'a conta: a resposta é não apostar. Não é conselho; é o que a fórmula devolve.',
          'A pesquisa garante a direção: quanto mais pesada a cauda, menor a fração ótima ' +
            '(Bamberg & Neuhierl, 2012; padrão de cauda em cripto em Grobys & Shahzad, 2025). O ' +
            'valor ótimo para memecoin ninguém resolveu, e nenhum índice de cauda (a medida de quão ' +
            'pesada ela é) das memecoins foi publicado: nem a premissa da cauda muito pesada vem de ' +
            'medição em memecoin.',
        ],
      },
    },
    {
      ...
      emUmaFrase:
        'Perder é mais rápido que recuperar, e a diferença cresce com a fração. É ' +
        'matemática, não sugestão de fração.',
      paragrafos: [
        'A calculadora responde: se várias posições seguidas forem a zero, quanto sobra do ' +
          'capital e quanto é preciso ganhar para voltar ao ponto de partida? Não prevê nada nem ' +
          'sugere fração: é aritmética.',
        'A fórmula: sobra = (1 − f) elevado a n (f é a fração, n o número de perdas), ou ' +
          'seja, (1 − f) multiplicado por ele mesmo n vezes, porque cada perda é recalculada ' +
          'sobre o que sobrou.',
        'O ganho para voltar é sempre maior que a perda, porque é calculado sobre um capital ' +
          'menor: perder metade exige +100% só para empatar.',
        'Os atalhos de 10% e 25% são só exemplos. Troque entre eles e olhe o ganho necessário: é ' +
          'ali que a diferença aparece mais forte.',
      ],
      quadro: [
        {
          rotulo: 'O que a calculadora é',
          texto:
            'Uma conta: cada posição perdida vai a zero e a fração é recalculada sobre o que ' +
            'sobrou, sem taxas nem ganhos no meio.',
        },
        {
          rotulo: 'O que ela não é',
          texto: 'Uma previsão de quantas perdas você vai ter, nem uma recomendação de fração.',
          destaque: true,
        },
      ],
      exemplo: {
        ...
        passos: [
          'Fração de 10% e uma perda total: sobram 90% do capital.',
          'Cinco perdas seguidas: 0,9 × 0,9 × 0,9 × 0,9 × 0,9 = 0,59. Sobram cerca de 59%.',
          'Por que não 50%? 50% seria se cada perda fosse sobre o capital inicial; ela é recalculada sobre o que sobrou.',
          'Para voltar ao começo, é preciso ganhar 69% sobre esse capital que restou.',
          'Perdi 5 vezes uma fatia pequena, e agora preciso de um ganho grande para empatar.',
        ],
      },
      paragrafosFinais: [
        'O erro que isso evita é somar porcentagens de cabeça: perder 10% cinco vezes não é ' +
          'perder 50%, porque as perdas se multiplicam. E o ganho para voltar cresce mais rápido ' +
          'do que a intuição acompanha.',
        'Com qual custo você convive não é conta: é escolha sua, sobre a sua vida.',
      ],
    },
    {
      id: 'ruina',
      ...
      paragrafos: [
        'A ruína do apostador é um resultado clássico de probabilidade: quem aposta ' +
          'repetidamente com uma desvantagem pequena, e só para ao quebrar ou ao chegar a um alvo, ' +
          'quase certamente quebra antes.',
        'Na roleta da grade, a chance de quebrar é de 99,5%, e por isso os 100 quadrados ' +
          'estão vermelhos. Numa rodada, 18 em 38 parece quase metade, e a intuição acha que dá ' +
          'para brigar. A conta olha a repetição — e repetição é o que existe em qualquer rotina ' +
          'de operações.',
        'Daí a troca dos cartões. "Quanto cresce" é a pergunta do critério de Kelly, que não ' +
          'tem resposta quando a média pode nem existir. Quanto você aguenta perder inteiro ' +
          'em cada posição depende da sua vida, não do mercado.',
      ],
      quadro: [
        {
          rotulo: 'Conta',
          texto:
            'Os 99,5% da roleta: probabilidade calculada pelas regras do jogo (ruína do ' +
            'apostador, Feller), não medição de jogadores reais.',
        },
        {
          rotulo: 'Medição',
          texto:
            'Os 68,67% do Pump.fun: contagem de tokens que existiram, feita sobre dados on-chain ' +
            '(CoinGecko Research).',
          destaque: true,
        },
      ],
      paragrafosFinais: [
        'E perder inteiro é o caso comum: 68,67% dos tokens do Pump.fun pararam de negociar no ' +
          'mesmo dia em que nasceram. É o desfecho mais frequente já contado, não precaução ' +
          'exagerada.',
        'O erro que isso evita é pensar por rodada: parece que basta acertar um pouco mais ' +
          'do que errar, mas ser eliminado encerra o jogo antes de a média aparecer.',
      ],
    },
    ...
    // ================================ DIÁRIO =================================
    {
      ...
      comparacao: {
        descricao:
          'Tem lastro: o registro ajuda a seguir a própria regra — monitorar aumentou o ' +
          'cumprimento de metas. Não tem lastro: o registro faz ganhar dinheiro — nenhum ' +
          'estudo revisado por pares mediu isso.',
        cartoes: [
          {
            tom: 'bom',
            rotulo: 'Tem lastro',
      ...
      grade: {
        ...
        descricao:
          'Sorteando alguém que monitorou e alguém que não, há 61 chances em 100 de o ' +
          'primeiro ter cumprido mais a meta. Sem efeito, seriam 50 em 100.',
      },
      paragrafos: [
        'O diário de operações é o registro escrito e datado do que você decidiu antes de saber ' +
          'como termina. Não é relatório de lucro nem caderno sobre o mercado.',
        '"Ter lastro" é ter evidência por trás. Diário levando a retorno, nenhum estudo ' +
          'revisado por pares mediu — nem a favor, nem contra.',
        'O que existe medido vem de uma meta-análise (estudo que junta muitos experimentos): ' +
          '138 experimentos, 19.951 pessoas. Monitorar o progresso teve efeito de d = 0,40 ' +
          'sobre cumprir metas de comportamento. Na régua do "d", 0,2 é pequeno, 0,5 é médio ' +
          'e 0,8 é grande: 0,40 é de pequeno a médio.',
        'Na grade, isso vira 61 chances em 100 contra 50 sem efeito: uma ajuda, não uma ' +
          'virada.',
      ],
      exemplo: {
        ...
        passos: [
          ...
          'Consequência de formato: escrever, mesmo que ninguém leia, vale mais do que repassar de cabeça.',
          'O limite: isso foi medido em metas de saúde e comportamento, não em operações.',
        ],
      },
      paragrafosFinais: [
        'O erro que isso evita é o mais caro do módulo: achar que o diário conserta a regra. ' +
          'Com uma regra ruim, ele só ajuda você a perder com mais método. O diário mede ' +
          'aderência (o quanto você segue a regra), não a qualidade dela — e a aba A revisão ' +
          'mostra por que essa é difícil de medir.',
        'E é a defesa contra discurso de venda: se disserem que diário melhora o desempenho ' +
          'em X%, lembre que ninguém mediu diário levando a retorno.',
      ],
      detalhe: {
        ...
        paragrafos: [
          ...
          'Levar a evidência de metas de saúde e comportamento para operações é inferência ' +
            'razoável, não fato medido — e o módulo trata assim do começo ao fim.',
        ],
      },
    },
    {
      ...
      paragrafos: [
        'São nove campos para copiar no seu caderno, e a proporção é a mensagem: oito registram ' +
          'comportamento, só o nono registra resultado em dinheiro. Com a proporção invertida, ' +
          'vira extrato, não diário.',
        'Os campos 1 a 6 são escritos antes de saber como termina; o 7, a saída executada, ' +
          'vem depois, e só então o 8 e o 9. Escrever os seis primeiros depois do resultado ' +
          'é perder o dado: a memória já reescreveu a história.',
        'O campo 7 fica em destaque porque é ele que deixa o campo 8 sair de uma comparação ' +
          'de textos (1 e 3 contra 7), e não da lembrança.',
        'Dois campos parecem opcionais e não são. A convicção de 1 a 5, depois de muitas ' +
          'operações, mostra se convicção alta acertou mais ou só apostou mais. O estado ' +
          'emocional — pressa, medo de ficar de fora (o FOMO do Módulo 2), vontade de ' +
          'recuperar uma perda — aparece no diário antes do saldo.',
      ],
      exemplo: {
        titulo: 'Como o campo 8 é respondido sem usar a memória',
        passos: [
          'Campo 1: a regra que você colou antes da entrada.',
          'Campo 3: entrada, saída por perda programada e alvo, escritos antes do desfecho.',
          ...
          'Só então se preenche o campo 9, o resultado em dinheiro. Ele não muda a resposta do campo 8.',
        ],
      },
      paragrafosFinais: [
        'O erro que isso evita é o diário só de resultado: parece objetivo, mas o resultado ' +
          'de uma operação isolada é quase todo sorte e não diz se você fez o que tinha ' +
          'escrito.',
      ],
    },
    ...
    // =============================== REVISÃO =================================
    {
      ...
      comparacao: {
        descricao:
          'Os experimentos mediram: olhar o dinheiro com frequência piora a decisão. Revisar ' +
          'se você seguiu a regra é o que o lastro do diário apoia.',
        cartoes: [
          {
            tom: 'ruim',
      ...
      paragrafos: [
        'São duas revisões opostas: olhar o dinheiro (quanto estou ganhando ou perdendo ' +
          'agora) e revisar o comportamento (fiz o que estava escrito?).',
        'Os experimentos mediram: olhar o dinheiro com frequência piora a decisão sob risco. ' +
          'É a aversão míope à perda. Aversão à perda é a perda doer mais do que um ganho do ' +
          'mesmo tamanho alegra; "míope" porque, de perto, cada perda isolada ocupa a visão ' +
          'inteira. E as pessoas preferem olhar mesmo sendo prejudicadas: vontade de ' +
          'conferir não prova que conferir ajuda.',
        'A revisão que tem lastro é a do comportamento, e a pergunta dela, no quadro abaixo, ' +
          'troca o resultado pela decisão: perguntar pelo resultado já traz o desfecho e ' +
          'convida os cinco vieses — o funcionamento normal da cabeça, não defeito de ' +
          'caráter.',
        'Com que frequência revisar? Ninguém mediu. Semanal é uma escolha razoável para ' +
          'começar; anote a data e trate como teste, como qualquer parte da regra.',
      ],
      ...
      exemplo: {
        ...
        passos: [
          ...
          'Depois o campo 7: o que foi executado, com hora e preço.',
      ...
      paragrafosFinais: [
        'O erro que essa ordem evita é o viés de resultado disfarçado de autocrítica: saldo ' +
          'vermelho, "a regra está errada"; saldo verde, "está certa". Nos dois casos a conclusão ' +
          'veio do desfecho, que em cauda pesada é quase todo sorte no curto prazo.',
      ],
      detalhe: {
        ...
        paragrafos: [
          ...
          'Eles mediram decisão sob risco em experimento, variando a frequência com que a ' +
            'pessoa via o resultado. A frequência ideal de revisão para memecoin ninguém ' +
            'mediu, e o hub não vai inventar.',
        ],
      },
    },
    {
      ...
      paragrafos: [
        'A partir de quantas operações dá para dizer que o resultado veio da regra, e não da ' +
          'sorte? A resposta tem fórmula, e ela desanima.',
        'Primeiro, o SR (sigla em inglês do índice de Sharpe, aqui por operação): o retorno ' +
          'médio por operação dividido pelo desvio-padrão, que mede quanto os resultados ' +
          'variam em torno da média. SR pequeno quer dizer vantagem enterrada no ruído, a ' +
          'variação que vem do acaso.',
        'A conta é n ≈ (2 ÷ SR)². Com SR de 0,1 por operação, que já é bom, seriam 400 ' +
          'operações para o resultado se distinguir de zero (2 ÷ 0,1 = 20; 20 × 20 = 400). ' +
          'Com SR de 0,05, a metade, seriam 1.600: o SR entra ao quadrado.',
        'Ao lado disso, as suas 30 operações quase somem: vinte lucros em 30 cabem ' +
          'perfeitamente na sorte. E taxa de acerto sozinha não diz nada sem o tamanho dos ' +
          'ganhos e das perdas: se os 20 lucros foram pequenos e as 10 perdas, grandes, o ' +
          'saldo pode ficar negativo mesmo com 67% de acerto.',
      ],
      quadro: [
        {
          rotulo: 'Conta, não medição',
          texto:
            'Os 400 e os 1.600 saem da fórmula de Lo (2002), com dois valores de SR escolhidos ' +
            'como exemplo. Ninguém mediu o SR de ninguém aqui.',
        },
        {
          rotulo: 'E a conta tem uma condição',
          texto:
            'Vale só com variância finita, isto é, quando as oscilações têm um tamanho ' +
            'típico. Em memecoin, essa condição está em dúvida.',
          destaque: true,
        },
      ],
      paragrafosFinais: [
        'Em cauda pesada, a média demora muito mais para assentar, e até esses números ' +
          'seriam otimistas. Se a média nem existir, nenhum número basta. Ressalva: ninguém ' +
          'publicou o índice de cauda das memecoins; é premissa herdada de estudos de ' +
          'cripto.',
        'Outro agravante: testar várias versões da regra e guardar a que "funcionou" infla o ' +
          'resultado. Com só três tentativas independentes, a melhor já é provavelmente ' +
          'falsa: quanto mais versões, maior a chance de uma parecer boa por acaso.',
        'O erro que isso evita é promover sorte a habilidade. Vale para o módulo inteiro: o ' +
          'diário mostra se você seguiu a regra, não prova que ela ganha.',
      ],
      detalhe: {
        ...
        paragrafos: [
          ...
          'O caso extremo: com cauda pesada demais (α ≤ 1), a média da amostra nunca se ' +
            'estabiliza. O α é o índice de cauda: quanto menor, mais pesada a cauda. Abaixo ' +
            'desse limite, o número de operações que bastaria é nenhum.',
        ],
      },
    },
    ...
    // ================================ MITOS ==================================
    {
      ...
      paragrafos: [
        'Repare no formato: número preciso demais (23%, 73%, 95%), prazo curto e redondo (60 ' +
          'dias, 90 dias) e, às vezes, um nome de instituição para dar peso. E o "tem ' +
          'fonte?" quase nunca aparece quando esses números circulam.',
        'Três termos da lista. Drawdown: a maior queda do topo ao fundo do seu capital. CFD ' +
          '(contrato por diferença): contrato ligado ao preço de um ativo, em geral ' +
          'alavancado (você movimenta mais do que depositou, e a perda cresce junto), sem ' +
          'que você tenha o ativo. Day trade: comprar e vender no mesmo dia.',
        'O caso mais instrutivo é o "estudo da Universidade da Califórnia", distorção de ' +
          'dois estudos reais. O de Berkeley, campus dessa universidade, mostra quase o ' +
          'oposto: quem mais opera ganha menos. O 73 vem de outro estudo, sem relação com ' +
          'diário. Distorção engana mais que mentira: cada pedaço resiste a uma busca ' +
          'rápida.',
        'Esses números chegam — em anúncio, vídeo, curso — quando você está mais disposto a ' +
          'acreditar. Não é para decorar os seis casos: é para reconhecer o formato no ' +
          'sétimo.',
      ],
      ...
      exemplo: {
        ...
        passos: [
          ...
          'Na Europa: 74% a 89% das contas de varejo (de pessoas comuns) em CFD perdem dinheiro, segundo o regulador europeu (ESMA, 2018).',
          'No Brasil: entre 1.551 day traders da bolsa brasileira (B3) que persistiram mais de 300 dias, 97% perderam dinheiro e só 1,1% ganhou mais que um salário mínimo.',
          'No mesmo estudo, os autores não acharam evidência de aprendizado — o que derruba o "com prática, você fica lucrativo".',
        ],
      },
      paragrafosFinais: [
        'O erro que isso evita tem duas caras: engolir o número bonito pelo nome que vem ' +
          'junto, e o rebote — descobrir que "95% dos traders falham" é folclore e concluir ' +
          'que o pessimismo era exagero. Não era: os dados com amostra e método dizem que a ' +
          'maioria de quem opera com frequência perde. Muda a qualidade da prova, não a ' +
          'conclusão.',
      ],
      detalhe: {
        titulo: 'o que é cada fonte desta tabela',
        paragrafos: [
          'A ESMA é o regulador de mercados da União Europeia; a medida dela é de 23/03/2018, ' +
            'com perda média por cliente de € 1.600 a € 29.000.',
          ...
          'O "verdadeiro estudo da Califórnia" é Barber & Odean (2000), "Trading Is Hazardous to ' +
            ...
            'piores.',
          'Os números sem fonte (o "23% em 60 dias" e o "drawdown 25% a 30%") vêm de blogs ' +
            'de plataforma de diário, sem estudo, autor ou método: não há nada para ' +
            'conferir.',
        ],
      },
    },
  ...
  destaques: {
    regra: [
      {
        rotulo: 'Quem fez day trade na bolsa (B3) por mais de 300 dias e perdeu',
        valor: '97%',
      ...
      },
      {
        ...
        valor: 'Você',
        nota: 'O módulo mostra a forma; o conteúdo fica no papel antes do próximo token.',
      },
    ],
    tamanho: [
      {
        ...
        valor: '0',
        nota: 'Kelly é a fórmula de quanto apostar. Aqui a perda total domina a conta.',
      },
      {
    ...
    revisao: [
      {
        ...
        valor: '400–1.600',
        nota: 'Com SR (explicado abaixo) de 0,1 a 0,05: n ≈ (2 ÷ SR)² (Lo, 2002).',
      },
      {
        rotulo: 'Operações que bastam se a média do retorno não existir',
        valor: 'Nenhuma',
        nota: 'Com cauda pesada demais, a média da amostra nunca se estabiliza.',
        tom: 'alerta',
      },
      {
