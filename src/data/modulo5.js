    ...
    // ================================ CUSTÓDIA ================================
    {
      ...
      paragrafos: [
        'Essa última é a prova prática mais forte: uma plataforma que te entrega a semente ' +
          'não está guardando o seu dinheiro. A parte pesada é que a segurança passa a ser ' +
          '100% sua — nenhum suporte recupera fundos perdidos, reverte uma assinatura ou ' +
          'desfaz uma operação ruim.',
      ],
      pergunta: 'q1',
    },
    {
    ...
    // ============================== CONFIGURAÇÕES ==============================
    {
      ...
      paragrafos: [
        'A documentação da Solana diz que limitar o slippage é a defesa mais eficaz contra ' +
          'ataques de sandwich — o bot que compra logo antes de você e vende logo depois. Na ' +
          'proteção de MEV, a própria documentação do Axiom recomenda o modo Secure sempre ' +
          'que possível.',
      ],
