...
export const cenarios = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    descricao:
      ...
      'atingiu o limiar de graduação (no Pump.fun ele é definido em tokens vendidos na ' +
      'curva, não em dólar) e a liquidez migrou para a DEX. O livro ficou mais fundo: ' +
      'agora dá para vender um valor maior sem derrubar o preço.',
    sinais: [
