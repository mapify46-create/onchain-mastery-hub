...
Vídeo PROCEDIMENTAL. Passo a passo genérico (vale para qualquer carteira da categoria), com ênfase no momento da frase-semente: onde anotar, onde NUNCA salvar. Ilustração esquemática de telas — não captura de tela de um produto real.

**Conexões:** Continua direto no vídeo 9 (seed). O checklist de segurança do app deve ser mencionado como "próximo passo".
