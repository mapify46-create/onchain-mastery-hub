...
- **2** — Saídas em "não opero" no fluxo. Checagem reprovada, ou tese que não fica clara. Passar na maioria das vezes é o comportamento esperado.
- **1ª operação** — Quando nasce a obrigação de registrar. Não quando aparece lucro. Data, valor em reais e custo de aquisição de cada compra e venda.
- **Não verificado** — Exportação de histórico pelo terminal. Nenhuma página oficial sobre isso. O histórico on-chain sempre pode ser exportado do explorador.
...
### Do token visto à posição encerrada
...
6. Acompanho a posição e saio em degraus, conforme o plano definido antes da entrada.
7. Encerro a posição.
